...
```shell
yosys
read liberty -lib /path/to/sky130_fd_sc_hd__tt_025C_1v80.lib
read verilog (file_name.v)
synth -top (provide file name)
abc -liberty /path/to/sky130_fd_sc_hd__tt_025C_1v80.lib {This links design file to the library}
